...
class HtmlHeader extends Html {
	 ...
	 */
	public static function Script( $url_script ) {
	 ...
	 */
	public static function Css( $url_css ) {
		
		return "<link rel=\"stylesheet\" type=\"text/css\" href=\"" . $url_css . "\">";
		
	}
	
	public static function Location( $url, $root_url = ROOTURL ) {
	 ...
	 */
	public static function CacheControl( $type = 'must-revalidate' ) {

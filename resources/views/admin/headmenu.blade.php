  ...
  <div class="container-fluid">
    ...
    <div id="navbar" class="navbar-collapse collapse">
      ...
      <ul id="user-menu" class="nav navbar-nav navbar-right">
        <li><a href="/" target="_blank" title="voir le site"><i class="fa fa-bell fa-lg"></i><span class="caret"></span></a></li>
        <li><a href="/" target="_blank" title="voir le site"><i class="fa fa-envelope fa-lg"></i><span class="caret"></span></a></li>
        <li><a href="/" target="_blank" title="voir le site"><i class="fa fa-eye fa-lg"></i></a></li>
        <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"expanded="false">
                  <i class="fa fa-user fa-lg"></i>&nbsp;{{App\Model\Users::getUserName(Session::get('Auth', 'id'))}}&nbsp;<span class="caret"></span>
                </a>
